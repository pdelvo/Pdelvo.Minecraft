...
namespace Pdelvo.Minecraft.Protocol
{
    ...
    public static class EnchantHelper
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes", Justification="ReadOnlyCollection is read only.")]
        public static readonly ReadOnlyCollection<short> Enchantable = new ReadOnlyCollection<short>(new short[]
                                                         {
