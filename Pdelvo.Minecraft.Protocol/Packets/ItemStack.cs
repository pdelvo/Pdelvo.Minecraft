...
namespace Pdelvo.Minecraft.Protocol.Packets
{
    ...
    {
        private static readonly short[] _12w18a = new short[]
                                                      {
                                                          0x182, // Book & Quills
                                                          0x183, //Written Book
        ...
        public static ItemStack Read(BigEndianStream stream)
        {
            ...
            if ((stack.ItemType = stream.ReadInt16 ()) >= 0)
            {
                ...
                return stack;
            if (((stream.Owner as PacketEndPoint).Version >= 36 && stack.ItemType != -1) ||
                (EnchantHelper.Enchantable.Contains(stack.ItemType) &&
                 !((stream.Owner as PacketEndPoint).Use12w18aFix && !(_12w18a.Contains(stack.ItemType))))) //12w18a fix
            {
